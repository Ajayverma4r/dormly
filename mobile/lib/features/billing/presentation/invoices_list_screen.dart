...
class InvoicesListScreen extends ConsumerWidget {
  ...
  /// When embedded as a bottom-nav tab, title becomes "Payments".
  final bool asTab;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(asTab ? 'Payments' : 'Rent & Billing'),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Create your first rent invoice for a tenant.',
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  subtitle: Text(
                      '${inv['node_name']} · Due ${inv['due_date'].toString().split('T').first}'),
                  trailing: Column(
                    ...
                    await Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => InvoiceDetailScreen(
                            propertyId: propertyId, invoiceId: inv['id']),
                      ),
                    );
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          final created = await Navigator.of(context).push<bool>(
            MaterialPageRoute(
                builder: (context) =>
                    CreateInvoiceScreen(propertyId: propertyId)),
          );
